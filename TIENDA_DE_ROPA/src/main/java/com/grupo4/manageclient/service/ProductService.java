...
public class ProductService {
    ...
    private void validateProductData(int id_product, String name, String size, String color, double price, int stock) {
        if (id_product <= 0) {
    ...
    public void registerProduct(int id_product, String name, String size, String color, double price, int stock) {
        validateProductData(id_product, name, size, color, price, stock);

        if (productRepository.findById(id_product) != null) {
            throw new IllegalArgumentException("El ID ya existe. Por favor, elige otro.");
        }

        Product product = new Product(id_product, name, size, color, price, stock);
    ...
    public void updateProduct(int id_product, String name, String size, String color, double price, int stock) {
        validateProductData(id_product, name, size, color, price, stock);
        ...
        Product updatedProduct = new Product(id_product, name, size, color, price, stock);
